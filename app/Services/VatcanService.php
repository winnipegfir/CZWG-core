...
class VatcanService
{
    ...
    public function parsePublicRoster(string $html): array
    {
        ...
        if (! $visitorTable) {
            return ['status' => 'error', 'message' => 'VATCAN roster format changed: Visiting Controllers table was not found.', 'data' => null];
        }
        ...
        return [
            ...
            'data' => ['controllers' => $controllers['members'], 'visitors' => $visitorResult['members']],
        ];
    }
