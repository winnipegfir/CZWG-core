...
class Course extends Model
{
    ...
    protected $fillable = ['title', 'slug', 'description', 'thumbnail', 'icon', 'sort_order', 'published', 'default_enrollment', 'visitor_only', 'created_by', 'updated_by'];

    protected $casts = ['published' => 'boolean', 'default_enrollment' => 'boolean', 'visitor_only' => 'boolean'];
