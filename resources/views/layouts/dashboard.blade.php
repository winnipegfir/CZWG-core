...
<html lang="en">
    <head>
        ...
        <!--CZQO specific CSS (loaded early, before render-blocking scripts below, so dark mode applies before first paint)-->
        @if (Auth::check())
    ...
    <header>
        <nav id="czwgDashHeader" class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                ...
                <button class="navbar-toggler border-0" type="button" data-toggle="collapse" data-target="#dashNavbar"
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @if(Auth::check() && Auth::user()->permissions >= 4)
                            <li class="nav-item dropdown {{ Request::is('news') || Request::is('news/*') ? 'active' : '' }}">
                                <a class="nav-link dropdown-toggle" id="dashDropNews" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">News</a>
                                <div class="dropdown-menu" aria-labelledby="dashDropNews">
                        ...
                        @if(Auth::check() && Auth::user()->permissions >= 4)
                            <li class="nav-item dropdown {{ Request::is('events') || Request::is('events/*') ? 'active' : '' }}">
                                <a class="nav-link dropdown-toggle" id="dashDropEvents" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Events</a>
                                <div class="dropdown-menu" aria-labelledby="dashDropEvents">
                        ...
                        <li class="nav-item dropdown {{ Request::is('roster') || Request::is('atcresources') || Request::is('join') || Request::is('training') ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" id="dashDropATC" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ATC</a>
                            <div class="dropdown-menu" aria-labelledby="dashDropATC">
                        ...
                        {{-- Academy is visible only to accepted FIR members. Keep this in the dashboard header too so it is available site-wide. --}}
                        ...
                        <li class="nav-item dropdown {{ Request::is('airports') ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" id="dashDropPilots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pilots</a>
                            <div class="dropdown-menu" aria-labelledby="dashDropPilots">
                        ...
                        <li class="nav-item dropdown {{ Request::is('policies') || Request::is('meetingminutes') || Request::is('privacy') ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" id="dashDropPubs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Publications</a>
                            <div class="dropdown-menu" aria-labelledby="dashDropPubs">
                        ...
                        <li class="nav-item dropdown {{ Request::is('feedback') || Request::is('yourfeedback') ? 'active' : '' }}">
                            <a class="nav-link dropdown-toggle" id="dashDropFeedback" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Feedback</a>
                            <div class="dropdown-menu" aria-labelledby="dashDropFeedback">
                    ...
                    <ul class="navbar-nav ml-auto align-items-center">
                        ...
                        @auth
                            ...
                            <li class="nav-item dropdown mr-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dashUserDrop">
