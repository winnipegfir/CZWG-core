...
<html lang="en">
    <head>
        ...
        @switch (Auth::user()->preferences)
            @case("default")
            <link href="{{ asset('css/czqomd.css') }}?v=30" rel="stylesheet">
            @break
            @default
            <link href="{{ asset('css/czqomd.css') }}?v=30" rel="stylesheet">
        @endswitch
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown {{ Request::is('airports') || Request::is('pdc') ? 'active' : '' }}">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navDropPilots">
                                ...
                                <a class="dropdown-item" href="https://vatsim-radar.com" target="_blank">Live Map</a>
                            </div>
                        </li>
    ...
    <script>
    (function() {
        var nav = document.getElementById('czwgHeader');
