                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="CYPG" style="text-align: center;">
                                        <div class="ATIS">
                                            <h5>ATIS</h5>
                                            <h1 style="font-size:45px;"><b>{{$cypgLetter}}</b></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="CYXE" style="text-align: center;">
                                        <div class="ATIS">
                                            <h5>ATIS</h5>
                                            <h1 style="font-size:45px;"><b>{{$cyxeLetter}}</b></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="CYQT" style="text-align: center;">
                                        <div class="ATIS">
                                            <h5>ATIS</h5>
                                            <h1 style="font-size:45px;"><b>{{$cyqtLetter}}</b></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="CYQR" style="text-align: center;">
                                        <div class="ATIS">
                                            <h5>ATIS</h5>
                                            <h1 style="font-size:45px;"><b>{{$cyqrLetter}}</b></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="CYMJ" style="text-align: center;">
                                        <div class="ATIS">
                                            <h5>ATIS</h5>
                                            <h1 style="font-size:45px;"><b>{{$cymjLetter}}</b></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
