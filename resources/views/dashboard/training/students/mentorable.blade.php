...
<div class="container">
    ...
    <div class="d-flex align-items-center mb-4">
        <div>
            <h2 class="font-weight-bold mb-0" style="color:#122b44;">Mentorable Students</h2>
            <p class="text-muted mb-0" style="font-size:0.875rem;">{{ $students->count() }} student{{ $students->count() != 1 ? 's' : '' }} open to booking with any instructor</p>
        </div>
    </div>
    ...
    @if($students->isEmpty())
        <div class="card">
            <div class="card-body text-center text-muted py-5">
                ...
                <p class="mb-0">No students are currently marked mentorable.</p>
            </div>
        </div>
    @else
        <div class="card">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle; color:#495057;">
                                ...
                                @else
                                    <span style="background:#fef3c7; color:#92400e; font-size:0.72rem; font-weight:700; padding:0.2em 0.55em; border-radius:0.3rem;">Waitlisted</span>
                                @endif
                            </td>
                            <td style="vertical-align:middle;">
