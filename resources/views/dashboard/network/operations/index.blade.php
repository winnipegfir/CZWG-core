...
<div class="ops-hero">
    <div class="container-fluid px-md-5">
        <a href="{{ route('network.index') }}"><i class="fas fa-arrow-left mr-1"></i> Network Data</a>
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mt-3">
            ...
            <div class="ops-range btn-group mt-3 mt-md-0" role="group" aria-label="Reporting period">
                @foreach([7, 30, 90] as $range)
                    <a class="btn btn-sm btn-outline-light {{ $days === $range ? 'active' : '' }}" href="{{ route('network.operations.index', ['days' => $range]) }}">{{ $range }} days</a>
                @endforeach
            </div>
        </div>
    </div>
...
<div class="ops-page">
    <div class="container-fluid px-md-5">
        <div class="ops-note mb-4">
            <strong>Operational planning only.</strong> These are five-minute VATSIM observations intended to identify coverage and training opportunities—not to rank or evaluate individual controllers. Top-down Winnipeg coverage is included where applicable.
        </div>
        ...
        @else
            ...
            <div class="row">
                @foreach($airports as $airport)
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="ops-panel">
                            <div class="ops-kicker">{{ $airport->icao }}</div>
                            <h5 class="font-weight-bold mb-3">{{ $airport->name }}</h5>
            ...
            <div class="row mt-2">
                <div class="col-xl-8 mb-4"><div class="ops-panel">
                    <div class="ops-kicker">Snapshot-derived flight tracking</div><h4 class="font-weight-bold mb-3">Flight-level operating time</h4>
                    <div class="row mb-4">
                    ...
                    @else
                        <div class="table-responsive"><table class="table ops-table mb-0"><thead><tr><th>Flight</th><th>Route</th><th>Airport</th><th>Ground</th><th>Airborne</th><th>Under ATC</th><th>Status</th></tr></thead><tbody>
            ...
            <div class="ops-panel mt-2">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <small class="text-muted">Utilization = staffed samples containing relevant traffic</small>
                </div>
