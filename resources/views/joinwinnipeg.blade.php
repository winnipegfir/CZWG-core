				...
				<div class="tab-pane fade" id="visit" role="tabpanel" aria-labelledby="visit"><br>
					<div class="card">	
						<div class="card-body btn-primary">
							<text>Winnipeg is currently welcoming visiting applications for active controllers holding a Student 3 (S3) rating or above! See below for information on how to apply.</text>
						</div>
					</div>
					<br>
