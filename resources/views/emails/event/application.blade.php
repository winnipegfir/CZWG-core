...
@section('message-content')
    ...
    <br><br>
    You requested {{$app->position}} and are available between {{$app->start_availability_timestamp}}z to {{$app->end_availability_timestamp}}z. If you need to make amendments, <a href="{{url('/staff')}}">please contact the Events Coordinator.</a>
    <br><br>
