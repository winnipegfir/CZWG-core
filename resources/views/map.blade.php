...
<html lang="en">
    <head>
        ...
        <!--Rich Preview Meta-->
        <title>Map - Winnipeg FIR</title>
        <meta name="theme-color" content="#000000">
        <meta name="og:title" content="Map - Winnipeg FIR">
    ...
    <body>
        ...
        <script>
            createBigMap(@php echo json_encode($planes); @endphp, @php echo json_encode($finalPositions ?? ''); @endphp);
        </script>
        <!-- Frame Modal Bottom -->
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="row d-flex justify-content-center align-items-center">
                    <p class="pt-3 pr-2">This map updates approx. every 15 minutes with VATSIM network data. It should not be taken as an up to date reflection of VATSIM.</p>
