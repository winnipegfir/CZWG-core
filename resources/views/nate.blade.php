...
@section('content')
    ...
    <div class="container py-4">
        ...
        <h3 class="blue-text">Nate's VATSIM career!</h3><br>
            ...
            <br>
            <p>Nate has {{$atcTime}} hours as a VATSIM controller and {{$pilotTime}} as a pilot! This comes to a total of {{$totalTime}}, Nate really has put in a lot of time eh? He started on the VATSIM network like most people do, flying. During this time, he gained a strong appreciation for all things aviation, which he carries on to this very day. But, one day, he decided that he wanted to enhance his VATSIM experience by becoming a controller, of course. Nate started in the Moncton/Gander FIR because it was where he lives.</p>
