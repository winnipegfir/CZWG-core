...
return new class extends Migration
{
    ...
    {
        // Never discard mentor session history to make a rollback succeed.
        if (DB::table('training_sessions')->whereNull('instructor_id')->exists()) {
            throw new \RuntimeException('Rollback stopped: mentor sessions exist. Preserve or explicitly reconcile them before removing provider support.');
        }
